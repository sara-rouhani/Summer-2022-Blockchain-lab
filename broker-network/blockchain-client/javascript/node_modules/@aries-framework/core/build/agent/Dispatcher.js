...
let Dispatcher = class Dispatcher {
        ...
        try {
            ...
            if (problemReportMessage instanceof ProblemReportMessage_1.ProblemReportMessage && messageContext.connection) {
                ...
                this.logger.error(`Error handling message with type ${message.type}`, {
                    ...
                    error,
                    senderKey: (_a = messageContext.senderKey) === null || _a === void 0 ? void 0 : _a.fingerprint,
                    recipientKey: (_b = messageContext.recipientKey) === null || _b === void 0 ? void 0 : _b.fingerprint,
                    connectionId: (_c = messageContext.connection) === null || _c === void 0 ? void 0 : _c.id,
                });
                throw error;
            }
        }
    ...
    getHandlerForType(messageType) {
        const incomingMessageType = messageType_1.parseMessageType(messageType);
        for (const handler of this.handlers) {
            for (const MessageClass of handler.supportedMessages) {
                if (messageType_1.canHandleMessageType(MessageClass, incomingMessageType))
                    return handler;
            }
        }
    }
