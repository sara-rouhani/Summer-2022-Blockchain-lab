...
export declare type ConstructableAgentMessage = Constructor<AgentMessage> & {
...
declare const Decorated: {
    ...
    new (...args: any[]): {
        appendedAttachments?: import("../decorators/attachment/Attachment").Attachment[] | undefined;
        getAppendedAttachmentById(id: string): import("../decorators/attachment/Attachment").Attachment | undefined;
        addAppendedAttachment(attachment: import("../decorators/attachment/Attachment").Attachment): void;
        id: string;
        readonly type: string;
        generateId(): string;
    };
