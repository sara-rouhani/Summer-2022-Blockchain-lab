 ...
 */
export declare function migrateMediationRecordToV0_2(agent: Agent, upgradeConfig: V0_1ToV0_2UpdateConfig): Promise<void>;
/**
 ...
 *
 */
export declare function updateMediationRole(agent: Agent, mediationRecord: MediationRecord, { mediationRoleUpdateStrategy }: V0_1ToV0_2UpdateConfig): Promise<void>;
