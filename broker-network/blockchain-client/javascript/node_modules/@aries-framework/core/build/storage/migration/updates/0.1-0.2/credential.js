...
async function migrateCredentialRecordToV0_2(agent) {
    ...
    const credentialRepository = agent.injectionContainer.resolve(CredentialRepository_1.CredentialRepository);
...
async function moveDidCommMessages(agent, credentialRecord) {
    ...
    const didCommMessageRepository = agent.injectionContainer.resolve(didcomm_1.DidCommMessageRepository);
