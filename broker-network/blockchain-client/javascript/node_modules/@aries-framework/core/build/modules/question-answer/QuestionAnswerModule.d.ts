...
export declare class QuestionAnswerModule {
    ...
    sendQuestion(connectionId: string, config: {
        ...
        detail?: string;
    }): Promise<import("./repository").QuestionAnswerRecord>;
    /**
     ...
     * @returns QuestionAnswer record
     */
    sendAnswer(questionRecordId: string, response: string): Promise<import("./repository").QuestionAnswerRecord>;
    /**
     * Get all QuestionAnswer records
     *
     * @returns list containing all QuestionAnswer records
     */
    getAll(): Promise<import("./repository").QuestionAnswerRecord[]>;
