...
function IsDidKeyString(validationOptions) {
    return class_validator_1.ValidateBy({
        name: 'isDidKeyString',
        validator: {
            validate: (value) => class_validator_1.isString(value) && value.startsWith('did:key:'),
            defaultMessage: class_validator_1.buildMessage((eachPrefix) => eachPrefix + '$property must be a did:key string', validationOptions),
        },
    }, validationOptions);
}
