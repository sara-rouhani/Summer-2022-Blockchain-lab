...
PresentationPreview.type = messageType_1.parseMessageType('https://didcomm.org/present-proof/1.0/presentation-preview');
__decorate([
    class_transformer_1.Expose({ name: '@type' }),
    messageType_1.IsValidMessageType(PresentationPreview.type),
