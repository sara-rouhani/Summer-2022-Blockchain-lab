...
V2OfferCredentialMessage.type = messageType_1.parseMessageType('https://didcomm.org/issue-credential/2.0/offer-credential');
__decorate([
    class_transformer_1.Type(() => models_1.CredentialFormatSpec),
    class_validator_1.ValidateNested(),
    class_validator_1.IsArray(),
    class_validator_1.IsInstance(models_1.CredentialFormatSpec, { each: true }),
    __metadata("design:type", Array)
], V2OfferCredentialMessage.prototype, "formats", void 0);
__decorate([
    messageType_1.IsValidMessageType(V2OfferCredentialMessage.type),
...
__decorate([
    ...
    class_transformer_1.Type(() => V2CredentialPreview_1.V2CredentialPreview),
    class_validator_1.ValidateNested(),
    class_validator_1.IsInstance(V2CredentialPreview_1.V2CredentialPreview),
...
__decorate([
    class_transformer_1.Expose({ name: 'replacement_id' }),
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    __metadata("design:type", String)
