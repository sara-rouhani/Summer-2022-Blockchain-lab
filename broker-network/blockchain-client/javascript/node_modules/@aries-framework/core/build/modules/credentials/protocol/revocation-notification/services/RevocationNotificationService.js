...
let RevocationNotificationService = class RevocationNotificationService {
    constructor(credentialRepository, eventEmitter, agentConfig, dispatcher) {
    ...
    async processRevocationNotification(indyRevocationRegistryId, indyCredentialRevocationId, connection, comment) {
    ...
    async v1ProcessRevocationNotification(messageContext) {
        ...
        try {
            ...
            await this.processRevocationNotification(indyRevocationRegistryId, indyCredentialRevocationId, connection, comment);
        }
        catch (error) {
    ...
    registerHandlers() {
        this.dispatcher.registerHandler(new handlers_1.V1RevocationNotificationHandler(this));
        this.dispatcher.registerHandler(new handlers_1.V2RevocationNotificationHandler(this));
    }
};
