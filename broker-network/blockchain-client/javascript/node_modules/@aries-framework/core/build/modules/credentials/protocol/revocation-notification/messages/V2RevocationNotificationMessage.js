...
V2RevocationNotificationMessage.type = messageType_1.parseMessageType('https://didcomm.org/revocation_notification/2.0/revoke');
__decorate([
    messageType_1.IsValidMessageType(V2RevocationNotificationMessage.type),
...
__decorate([
    class_transformer_1.Expose({ name: 'revocation_format' }),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], V2RevocationNotificationMessage.prototype, "revocationFormat", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'credential_id' }),
    class_validator_1.IsString(),
    __metadata("design:type", String)
