...
V2CredentialPreview.type = messageType_1.parseMessageType('https://didcomm.org/issue-credential/2.0/credential-preview');
__decorate([
    class_transformer_1.Expose({ name: '@type' }),
    messageType_1.IsValidMessageType(V2CredentialPreview.type),
