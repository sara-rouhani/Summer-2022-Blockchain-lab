...
class ConnectionInvitationMessage extends AgentMessage_1.AgentMessage {
    ...
    static fromUrl(invitationUrl) {
        ...
        if (typeof encodedInvitation === 'string') {
            ...
            throw new error_1.AriesFrameworkError('InvitationUrl is invalid. It needs to contain one, and only one, of the following parameters; `c_i` or `d_m`');
        }
    }
}
ConnectionInvitationMessage.type = messageType_1.parseMessageType('https://didcomm.org/connections/1.0/invitation');
__decorate([
    messageType_1.IsValidMessageType(ConnectionInvitationMessage.type),
