...
function IsStringOrVerificationMethod(validationOptions) {
    return class_validator_1.ValidateBy({
        ...
        validator: {
            validate: (value) => class_validator_1.isString(value) || class_validator_1.isInstance(value, VerificationMethod_1.VerificationMethod),
            defaultMessage: class_validator_1.buildMessage((eachPrefix) => eachPrefix + '$property must be a string or instance of VerificationMethod', validationOptions),
        },
    }, validationOptions);
}
