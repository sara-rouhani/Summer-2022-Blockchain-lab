...
let V2CredentialService = class V2CredentialService extends CredentialService_1.CredentialService {
    constructor(connectionService, didCommMessageRepository, agentConfig, mediationRecipientService, dispatcher, eventEmitter, credentialRepository, indyCredentialFormatService) {
    ...
    registerHandlers() {
        ...
        this.dispatcher.registerHandler(new handlers_1.V2OfferCredentialHandler(this, this.agentConfig, this.mediationRecipientService, this.didCommMessageRepository));
