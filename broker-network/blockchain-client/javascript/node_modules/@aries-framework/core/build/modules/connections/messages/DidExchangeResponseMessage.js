...
DidExchangeResponseMessage.type = messageType_1.parseMessageType('https://didcomm.org/didexchange/1.0/response');
__decorate([
    messageType_1.IsValidMessageType(DidExchangeResponseMessage.type),
...
__decorate([
    class_transformer_1.Expose({ name: 'did_doc~attach' }),
