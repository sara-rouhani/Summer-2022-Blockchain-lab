...
let MediationRecipientService = class MediationRecipientService {
    ...
    async getRouting({ mediatorId, useDefaultMediator = true } = {}) {
        ...
        const recipientKey = dids_1.Key.fromPublicKeyBase58(verkey, crypto_1.KeyType.Ed25519);
        if (mediationRecord) {
            routingKeys = mediationRecord.routingKeys.map((key) => dids_1.Key.fromPublicKeyBase58(key, crypto_1.KeyType.Ed25519));
        ...
        return { endpoints, routingKeys, recipientKey, mediatorId: mediationRecord === null || mediationRecord === void 0 ? void 0 : mediationRecord.id };
    }
