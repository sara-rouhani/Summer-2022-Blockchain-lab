...
function IsStringOrStringArray(validationOptions) {
    return class_validator_1.ValidateBy({
        ...
        validator: {
            validate: (value) => class_validator_1.isString(value) || (Array.isArray(value) && value.every((v) => class_validator_1.isString(v))),
            defaultMessage: class_validator_1.buildMessage((eachPrefix) => eachPrefix + '$property must be a string or string array', validationOptions),
        },
    }, validationOptions);
}
