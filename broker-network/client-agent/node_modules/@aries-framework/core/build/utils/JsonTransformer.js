...
class JsonTransformer {
    static toJSON(classInstance) {
        return class_transformer_1.instanceToPlain(classInstance, {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    cls, { validate = true } = {}) {
        const instance = class_transformer_1.plainToInstance(cls, json, { exposeDefaultValues: true });
        // Skip validation
        if (!validate)
            return instance;
        if (!instance) {
    ...
    static clone(classInstance) {
        return class_transformer_1.instanceToInstance(classInstance, {
            exposeDefaultValues: true,
