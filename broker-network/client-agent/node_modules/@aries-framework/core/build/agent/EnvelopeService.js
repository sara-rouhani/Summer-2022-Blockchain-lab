...
let EnvelopeService = class EnvelopeService {
    ...
    async packMessage(payload, keys) {
        ...
        let encryptedMessage = await this.wallet.pack(message, recipientKeysBase58, senderKeyBase58 !== null && senderKeyBase58 !== void 0 ? senderKeyBase58 : undefined);
    ...
    async unpackMessage(encryptedMessage) {
        ...
        return {
            recipientKey: recipientKey ? dids_1.Key.fromPublicKeyBase58(recipientKey, crypto_1.KeyType.Ed25519) : undefined,
            senderKey: senderKey ? dids_1.Key.fromPublicKeyBase58(senderKey, crypto_1.KeyType.Ed25519) : undefined,
            plaintextMessage,
        };
    }
};
