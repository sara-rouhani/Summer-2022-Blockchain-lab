...
let IndyRevocationService = class IndyRevocationService {
    constructor(agentConfig, indyUtilitiesService, ledgerService, wallet) {
    ...
    async createRevocationState(proofRequest, requestedCredentials) {
        try {
            ...
            for (const { referent, credentialInfo, type } of referentCredentials) {
                ...
                if (requestRevocationInterval && credentialRevocationId && revocationRegistryId) {
                    ...
                    const { revocationRegistryDelta, deltaTimestamp } = await this.ledgerService.getRevocationRegistryDelta(revocationRegistryId, requestRevocationInterval === null || requestRevocationInterval === void 0 ? void 0 : requestRevocationInterval.to, 0);
    ...
    async getRevocationStatus(credentialRevocationId, revocationRegistryDefinitionId, requestRevocationInterval) {
        var _a;
        ...
        this.assertRevocationInterval(requestRevocationInterval);
        const { revocationRegistryDelta, deltaTimestamp } = await this.ledgerService.getRevocationRegistryDelta(revocationRegistryDefinitionId, requestRevocationInterval.to, 0);
