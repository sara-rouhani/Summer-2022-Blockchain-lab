...
KeylistUpdateMessage.type = messageType_1.parseMessageType('https://didcomm.org/coordinate-mediation/1.0/keylist-update');
__decorate([
    messageType_1.IsValidMessageType(KeylistUpdateMessage.type),
...
__decorate([
    ...
    class_validator_1.IsInstance(KeylistUpdate, { each: true }),
