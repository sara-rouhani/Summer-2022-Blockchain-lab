...
class OutOfBandRecord extends BaseRecord_1.BaseRecord {
    ...
    getTags() {
        return Object.assign(Object.assign({}, this._tags), { role: this.role, state: this.state, invitationId: this.outOfBandInvitation.id, recipientKeyFingerprints: this.outOfBandInvitation.getRecipientKeys().map((key) => key.fingerprint) });
    }
