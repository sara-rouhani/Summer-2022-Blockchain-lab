...
V1RevocationNotificationMessage.type = messageType_1.parseMessageType('https://didcomm.org/revocation_notification/1.0/revoke');
__decorate([
    messageType_1.IsValidMessageType(V1RevocationNotificationMessage.type),
...
__decorate([
    class_transformer_1.Expose({ name: 'thread_id' }),
    class_validator_1.IsString(),
    __metadata("design:type", String)
