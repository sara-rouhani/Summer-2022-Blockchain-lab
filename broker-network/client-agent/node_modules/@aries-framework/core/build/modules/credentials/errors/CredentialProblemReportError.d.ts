...
export declare class CredentialProblemReportError extends ProblemReportError {
    problemReport: V1CredentialProblemReportMessage;
    constructor(message: string, { problemCode }: CredentialProblemReportErrorOptions);
}
export {};
