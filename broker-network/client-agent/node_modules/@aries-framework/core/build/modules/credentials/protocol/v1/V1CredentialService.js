...
exports.V1CredentialService = void 0;
...
let V1CredentialService = class V1CredentialService extends services_2.CredentialService {
    constructor(connectionService, didCommMessageRepository, agentConfig, routingService, dispatcher, eventEmitter, credentialRepository, formatService) {
    ...
    getFormatServiceForRecordType(credentialRecordType) {
        if (credentialRecordType !== this.formatService.credentialRecordType) {
            throw new error_1.AriesFrameworkError(`Unsupported credential record type ${credentialRecordType} for v1 issue credential protocol (need ${this.formatService.credentialRecordType})`);
        }
     ...
     * @returns Object containing proposal message and associated credential record
     */
    async acceptProposal({ credentialRecord, credentialFormats, comment, autoAcceptCredential, }) {
        var _a;
        // Assert
        credentialRecord.assertProtocolVersion('v1');
     ...
     *
     */
    async negotiateProposal({ credentialFormats, credentialRecord, comment, autoAcceptCredential, }) {
        // Assert
        credentialRecord.assertProtocolVersion('v1');
        credentialRecord.assertState(CredentialState_1.CredentialState.ProposalReceived);
        if (credentialFormats)
     ...
     *
     */
    async acceptOffer({ credentialRecord, credentialFormats, comment, autoAcceptCredential, }) {
        var _a, _b;
        // Assert credential
        credentialRecord.assertProtocolVersion('v1');
        ...
        const requestMessage = new messages_1.V1RequestCredentialMessage({
            ...
            attachments: (_a = offerMessage.appendedAttachments) === null || _a === void 0 ? void 0 : _a.filter((attachment) => attachment_1.isLinkedAttachment(attachment)),
        });
        ...
        credentialRecord.autoAcceptCredential = autoAcceptCredential !== null && autoAcceptCredential !== void 0 ? autoAcceptCredential : credentialRecord.autoAcceptCredential;
        credentialRecord.linkedAttachments = (_b = offerMessage.appendedAttachments) === null || _b === void 0 ? void 0 : _b.filter((attachment) => attachment_1.isLinkedAttachment(attachment));
        await this.didCommMessageRepository.saveOrUpdateAgentMessage({
     ...
     *
     */
    async negotiateOffer({ credentialFormats, credentialRecord, autoAcceptCredential, comment, }) {
        // Assert
        credentialRecord.assertProtocolVersion('v1');
        credentialRecord.assertState(CredentialState_1.CredentialState.OfferReceived);
        this.assertOnlyIndyFormat(credentialFormats);
        ...
        credentialRecord.autoAcceptCredential = autoAcceptCredential !== null && autoAcceptCredential !== void 0 ? autoAcceptCredential : credentialRecord.autoAcceptCredential;
        await this.updateState(credentialRecord, CredentialState_1.CredentialState.ProposalSent);
        return { credentialRecord, message };
    }
    /**
    ...
    async processRequest(messageContext) {
        ...
        const credentialRecord = await this.getByThreadAndConnectionId(requestMessage.threadId, connection === null || connection === void 0 ? void 0 : connection.id);
     ...
     *
     */
    async acceptRequest({ credentialRecord, credentialFormats, comment, autoAcceptCredential, }) {
        // Assert
        credentialRecord.assertProtocolVersion('v1');
    ...
    async processCredential(messageContext) {
        ...
        const credentialRecord = await this.getByThreadAndConnectionId(issueMessage.threadId, connection === null || connection === void 0 ? void 0 : connection.id);
    ...
    registerHandlers() {
        this.dispatcher.registerHandler(new handlers_1.V1ProposeCredentialHandler(this, this.agentConfig));
        this.dispatcher.registerHandler(new handlers_1.V1OfferCredentialHandler(this, this.agentConfig, this.routingService, this.didCommMessageRepository));
        this.dispatcher.registerHandler(new handlers_1.V1RequestCredentialHandler(this, this.agentConfig, this.didCommMessageRepository));
        this.dispatcher.registerHandler(new handlers_1.V1IssueCredentialHandler(this, this.agentConfig, this.didCommMessageRepository));
        this.dispatcher.registerHandler(new handlers_1.V1CredentialAckHandler(this));
        this.dispatcher.registerHandler(new handlers_1.V1CredentialProblemReportHandler(this));
    }
...
V1CredentialService = __decorate([
...
exports.V1CredentialService = V1CredentialService;
//# sourceMappingURL=V1CredentialService.js.map