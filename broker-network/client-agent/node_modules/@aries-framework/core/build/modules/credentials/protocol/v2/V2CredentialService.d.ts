...
import type { CreateProposalOptions, CredentialProtocolMsgReturnType, AcceptProposalOptions, NegotiateProposalOptions, CreateOfferOptions, AcceptOfferOptions, NegotiateOfferOptions, CreateRequestOptions, AcceptRequestOptions, AcceptCredentialOptions, GetFormatDataReturn, CreateProblemReportOptions } from '../../CredentialServiceOptions';
...
export declare class V2CredentialService<CFs extends CredentialFormat[] = CredentialFormat[]> extends CredentialService<CFs> {
    ...
    constructor(connectionService: ConnectionService, didCommMessageRepository: DidCommMessageRepository, agentConfig: AgentConfig, routingService: RoutingService, dispatcher: Dispatcher, eventEmitter: EventEmitter, credentialRepository: CredentialRepository, indyCredentialFormatService: IndyCredentialFormatService);
    /**
     * The version of the issue credential protocol this service supports
     */
    readonly version: "v2";
    getFormatServiceForRecordType(credentialRecordType: CFs[number]['credentialRecordType']): CredentialFormatService<CredentialFormat>;
    /**
     ...
     *
     */
    createProposal({ connection, credentialFormats, comment, autoAcceptCredential, }: CreateProposalOptions<CFs>): Promise<CredentialProtocolMsgReturnType<AgentMessage>>;
    /**
    ...
    acceptProposal({ credentialRecord, credentialFormats, autoAcceptCredential, comment, }: AcceptProposalOptions<CFs>): Promise<CredentialProtocolMsgReturnType<V2OfferCredentialMessage>>;
    /**
     ...
     *
     */
    negotiateProposal({ credentialRecord, credentialFormats, autoAcceptCredential, comment, }: NegotiateProposalOptions<CFs>): Promise<CredentialProtocolMsgReturnType<V2OfferCredentialMessage>>;
    /**
     ...
     *
     */
    createOffer({ credentialFormats, autoAcceptCredential, comment, connection, }: CreateOfferOptions<CFs>): Promise<CredentialProtocolMsgReturnType<V2OfferCredentialMessage>>;
    /**
     ...
     * @returns credential record appropriate for this incoming message (once accepted)
     */
    processOffer(messageContext: HandlerInboundMessage<V2OfferCredentialHandler>): Promise<CredentialExchangeRecord>;
    acceptOffer({ credentialRecord, autoAcceptCredential, comment, credentialFormats, }: AcceptOfferOptions<CFs>): Promise<{
     ...
     *
     */
    negotiateOffer({ credentialRecord, credentialFormats, autoAcceptCredential, comment, }: NegotiateOfferOptions<CFs>): Promise<CredentialProtocolMsgReturnType<V2ProposeCredentialMessage>>;
    /**
     * Create a {@link V2RequestCredentialMessage} as beginning of protocol process.
     * @returns Object containing offer message and associated credential record
     *
     */
    createRequest({ credentialFormats, autoAcceptCredential, comment, connection, }: CreateRequestOptions<CFs>): Promise<CredentialProtocolMsgReturnType<V2RequestCredentialMessage>>;
    /**
    ...
    acceptRequest({ credentialRecord, autoAcceptCredential, comment, credentialFormats, }: AcceptRequestOptions<CFs>): Promise<{
        credentialRecord: CredentialExchangeRecord;
     ...
     *
     */
    acceptCredential({ credentialRecord, }: AcceptCredentialOptions): Promise<CredentialProtocolMsgReturnType<V2CredentialAckMessage>>;
    /**
    ...
    findProposalMessage(credentialExchangeId: string): Promise<V2ProposeCredentialMessage | null>;
    findOfferMessage(credentialExchangeId: string): Promise<V2OfferCredentialMessage | null>;
    findRequestMessage(credentialExchangeId: string): Promise<V2RequestCredentialMessage | null>;
    findCredentialMessage(credentialExchangeId: string): Promise<V2IssueCredentialMessage | null>;
    getFormatData(credentialExchangeId: string): Promise<GetFormatDataReturn>;
