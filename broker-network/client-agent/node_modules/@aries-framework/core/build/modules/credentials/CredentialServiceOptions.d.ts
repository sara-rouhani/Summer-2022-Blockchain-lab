 ...
 * ```
 */
export declare type FormatDataMessagePayload<CFs extends CredentialFormat[] = CredentialFormat[], M extends keyof CredentialFormat['formatData'] = keyof CredentialFormat['formatData']> = {
 ...
 * ```
 */
export declare type GetFormatDataReturn<CFs extends CredentialFormat[] = CredentialFormat[]> = {
