...
V1CredentialPreview.type = messageType_1.parseMessageType('https://didcomm.org/issue-credential/1.0/credential-preview');
__decorate([
    class_transformer_1.Expose({ name: '@type' }),
    messageType_1.IsValidMessageType(V1CredentialPreview.type),
...
__decorate([
    class_transformer_1.Type(() => CredentialPreviewAttribute_1.CredentialPreviewAttribute),
    class_validator_1.ValidateNested({ each: true }),
    class_validator_1.IsInstance(CredentialPreviewAttribute_1.CredentialPreviewAttribute, { each: true }),
