...
V1ProposeCredentialMessage.type = messageType_1.parseMessageType('https://didcomm.org/issue-credential/1.0/propose-credential');
__decorate([
    messageType_1.IsValidMessageType(V1ProposeCredentialMessage.type),
...
__decorate([
    class_transformer_1.Expose({ name: 'credential_proposal' }),
    class_transformer_1.Type(() => V1CredentialPreview_1.V1CredentialPreview),
    class_validator_1.ValidateNested(),
    class_validator_1.IsOptional(),
    class_validator_1.IsInstance(V1CredentialPreview_1.V1CredentialPreview),
...
__decorate([
    ...
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.Matches(utils_1.indyDidRegex),
    __metadata("design:type", String)
...
__decorate([
    ...
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.Matches(utils_1.schemaIdRegex),
    __metadata("design:type", String)
...
__decorate([
    ...
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.Matches(utils_1.schemaVersionRegex, {
...
__decorate([
    ...
    class_validator_1.IsString(),
    class_validator_1.IsOptional(),
    class_validator_1.Matches(utils_1.credDefIdRegex),
    __metadata("design:type", String)
