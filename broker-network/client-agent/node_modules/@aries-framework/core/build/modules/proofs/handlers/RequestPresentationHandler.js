...
class RequestPresentationHandler {
    constructor(proofService, agentConfig, proofResponseCoordinator, routingService) {
    ...
    async createPresentation(record, messageContext) {
        ...
        const presentationProposal = (_b = record.proposalMessage) === null || _b === void 0 ? void 0 : _b.presentationProposal;
