    ...
    get recipientKeys() {
        ...
        for (const service of this.didCommServices) {
            if (service instanceof service_1.IndyAgentService) {
                recipientKeys = [
                    ...recipientKeys,
                    ...service.recipientKeys.map((publicKeyBase58) => Key_1.Key.fromPublicKeyBase58(publicKeyBase58, crypto_1.KeyType.Ed25519)),
                ];
            }
...
__decorate([
    ...
    transformers_1.IsStringOrStringArray(),
...
async function findVerificationMethodByKeyType(keyType, didDocument) {
    ...
    try {
        for (var didVerificationMethods_1 = __asyncValues(didVerificationMethods), didVerificationMethods_1_1; didVerificationMethods_1_1 = await didVerificationMethods_1.next(), !didVerificationMethods_1_1.done;) {
            const purpose = didVerificationMethods_1_1.value;
            const key = didDocument[purpose];
            if (key instanceof Array) {
                try {
                    for (var key_1 = (e_2 = void 0, __asyncValues(key)), key_1_1; key_1_1 = await key_1.next(), !key_1_1.done;) {
                        const method = key_1_1.value;
                    ...
                    try {
                        if (key_1_1 && !key_1_1.done && (_b = key_1.return)) await _b.call(key_1);
                    }
        ...
        try {
            if (didVerificationMethods_1_1 && !didVerificationMethods_1_1.done && (_a = didVerificationMethods_1.return)) await _a.call(didVerificationMethods_1);
        }
