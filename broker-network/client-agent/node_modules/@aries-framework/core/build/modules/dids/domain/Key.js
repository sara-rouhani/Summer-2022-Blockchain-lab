...
const multiCodecKey_1 = require("./key-type/multiCodecKey");
class Key {
    ...
    static fromFingerprint(fingerprint) {
        ...
        const keyType = multiCodecKey_1.getKeyTypeByMultiCodecPrefix(code);
        return new Key(publicKey, keyType);
    }
    get prefixedPublicKey() {
        const multiCodecPrefix = multiCodecKey_1.getMultiCodecPrefixByKeytype(this.keyType);
