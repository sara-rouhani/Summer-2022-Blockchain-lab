 ...
 */
export declare function migrateCredentialRecordToV0_2(agent: Agent): Promise<void>;
 ...
 * ```
 */
export declare function updateIndyMetadata(agent: Agent, credentialRecord: CredentialExchangeRecord): Promise<void>;
/**
 ...
 * ```
 */
export declare function migrateInternalCredentialRecordProperties(agent: Agent, credentialRecord: CredentialExchangeRecord): Promise<void>;
/**
 ...
 */
export declare function moveDidCommMessages(agent: Agent, credentialRecord: CredentialExchangeRecord): Promise<void>;
