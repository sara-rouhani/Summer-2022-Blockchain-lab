 ...
 */
export declare function migrateConnectionRecordToV0_2(agent: Agent): Promise<void>;
/**
 ...
 * ```
 */
export declare function updateConnectionRoleAndState(agent: Agent, connectionRecord: ConnectionRecord): Promise<void>;
/**
 ...
 * ```
 */
export declare function extractDidDocument(agent: Agent, connectionRecord: ConnectionRecord): Promise<void>;
/**
 ...
 * ```
 */
export declare function migrateToOobRecord(agent: Agent, connectionRecord: ConnectionRecord): Promise<ConnectionRecord | undefined>;
/**
