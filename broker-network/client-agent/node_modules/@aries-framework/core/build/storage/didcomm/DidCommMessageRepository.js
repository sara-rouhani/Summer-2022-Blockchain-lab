...
let DidCommMessageRepository = class DidCommMessageRepository extends Repository_1.Repository {
    ...
    async saveAgentMessage({ role, agentMessage, associatedRecordId }) {
    ...
    async saveOrUpdateAgentMessage(options) {
        const { messageName, protocolName, protocolMajorVersion } = messageType_1.parseMessageType(options.agentMessage.type);
    ...
    async getAgentMessage({ associatedRecordId, messageClass, }) {
    ...
    async findAgentMessage({ associatedRecordId, messageClass, }) {
        var _a;
        const record = await this.findSingleByQuery({
            associatedRecordId,
            messageName: messageClass.type.messageName,
